...
const BuyerReviews = () => {
    ...
    const fetchReviews = async () => {
        try {
            setLoading(true);
            const response = await fetch(`http://localhost:8080/mypage/api/buyers/${userId}/reviews`);
            if (response.ok) {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/mypage/api/reviews/${editingReview.reviewId}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDeleteReview = async (reviewId) => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/mypage/api/reviews/${reviewId}`, {
                method: 'DELETE'
            });
